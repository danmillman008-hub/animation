...
export const RigTest: React.FC<{ id?: string }> = ({ id = "rusty" }) => (
  <AbsoluteFill style={{ background: "#e9e9f2" }}>
    <svg width={1920} height={1080} viewBox="0 0 1920 1080"><Defs />
      {P.map((p, i) => <Character key={i} id={id} st={{ x: 140 + i * 265, y: 0, facing: 1, scale: 0.42, blink: i === 0 ? 1 : 0, face: i === 1 ? "head_focus" : i === 2 ? "head_hurt" : i === 3 ? "head_back" : undefined, pose: p }} ground={1010} debug />)}
    </svg>
  </AbsoluteFill>
);
